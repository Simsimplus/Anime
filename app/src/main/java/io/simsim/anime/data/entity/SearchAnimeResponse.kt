...
data class SearchAnimeResponse(
    ...
    data class SearchAnimeData(
        ...
        @JsonClass(generateAdapter = true)
        data class Trailer(
            @Json(name = "embed_url") var embedUrl: Any = Any(),
            @Json(name = "images") var images: Images = Images(),
            @Json(name = "url") var url: Any = Any(),
            @Json(name = "youtube_id") var youtubeId: Any = Any()
        ) {
            @Keep
            @JsonClass(generateAdapter = true)
            data class Images(
                @Json(name = "image_url") var imageUrl: Any = Any(),
                @Json(name = "large_image_url") var largeImageUrl: Any = Any(),
                @Json(name = "maximum_image_url") var maximumImageUrl: Any = Any(),
                @Json(name = "medium_image_url") var mediumImageUrl: Any = Any(),
                @Json(name = "small_image_url") var smallImageUrl: Any = Any()
            )
        }
    }
